# -*- coding: utf-8 -*-
"""
Created on Wed Apr 27 13:28:47 2022
...
Intensity counter
    ...
    across Emotions without groundtruth 
"""
...
def affective_bias_finder(emotion, pair1_label, pair2_label):
    ...
    for i in range(len(pair1_emotion_indices[0])):
        ...
        if (sent_pair_1[indx][1] == sent_pair_2[indx][1]) & (sent_pair_1[indx][1] == emotion) & (sent_pair_2[indx][1] == emotion):
            ...
            #confidence score 
            confidence = 1 - (np.float64(sent_pair_1[indx][2])/np.float64(sent_pair_2[indx][2]))
...
#eval_corpus = 'csp'
#context = 'gender'
#model_name = 'T5' #'T5', 'XLNet', 'GPT-2', 'BERT'
...
file1 = open('sentence_paires_predictions/religion/csp/csp_muslim_104_csp_T5_predictions.csv')
file2 = open('sentence_paires_predictions/religion/csp/csp_jew_104_csp_T5_predictions.csv')
