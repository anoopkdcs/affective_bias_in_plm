# -*- coding: utf-8 -*-
"""
Created on Wed Apr 27 15:14:22 2022
...
def affective_bias_finder(data1, data2, pair1_label, pair2_label, model_name):
    ...
    for i in range(len(data1)):
        if(data1[i][2] == data2[i][2]) & (data1[i][1] == data2[i][1]) & (data1[i][1] == data1[i][2]) & (data2[i][1] == data2[i][2]):
            ...
            #confidence score 
            confidence = 1 - (np.float64(data1[i][3])/np.float64(data2[i][3]))
...
#eval_corpus = 'bits'
#context = 'gender'
pair1_label = 'euro american'
pair2_label = 'afro american'
